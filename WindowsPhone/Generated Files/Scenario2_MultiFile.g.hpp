...
void ::SDKSample::FilePicker::Scenario2::InitializeComponent()
{
    if (_contentLoaded)
        return;
    ...
    // Call LoadComponent on ms-appx:///Scenario2_MultiFile.xaml
    ::Windows::UI::Xaml::Application::LoadComponent(this, ref new ::Windows::Foundation::Uri(L"ms-appx:///Scenario2_MultiFile.xaml"), ::Windows::UI::Xaml::Controls::Primitives::ComponentResourceLocation::Application);
    ...
    // Get the Button named 'PickFilesButton'
    PickFilesButton = safe_cast<::Windows::UI::Xaml::Controls::Button^>(static_cast<Windows::UI::Xaml::IFrameworkElement^>(this)->FindName(L"PickFilesButton"));
...
void ::SDKSample::FilePicker::Scenario2::Connect(int connectionId, Platform::Object^ target)
{
