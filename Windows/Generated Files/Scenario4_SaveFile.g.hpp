...
void ::SDKSample::FilePicker::Scenario4::InitializeComponent()
{
    if (_contentLoaded)
        return;
    ...
    // Call LoadComponent on ms-appx:///Scenario4_SaveFile.xaml
    ::Windows::UI::Xaml::Application::LoadComponent(this, ref new ::Windows::Foundation::Uri(L"ms-appx:///Scenario4_SaveFile.xaml"), ::Windows::UI::Xaml::Controls::Primitives::ComponentResourceLocation::Application);
...
void ::SDKSample::FilePicker::Scenario4::Connect(int connectionId, Platform::Object^ target)
{
